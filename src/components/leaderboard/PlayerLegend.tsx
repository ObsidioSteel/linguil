...
const UpdateNameDialog = dynamic(() => import('@/components/leaderboard/UpdateNameDialog').then(mod => mod.UpdateNameDialog), {
  loading: () => <div className="w-6 h-6 flex items-center justify-center"></div>,
