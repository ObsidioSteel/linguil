...
const WordDisplay = memo<WordDisplayProps>(({ word, isOfflineGame, isAudioReady, onPlayAudio }) => {
  ...
  return (
    <div className="relative bg-muted p-4 rounded-lg mb-4 flex items-center justify-center">
      {/* Displays the word in transliteration and native script. */}
      <div className="grid grid-cols-[1fr_auto_1fr] items-center justify-center gap-4 w-full font-code text-3xl font-semibold text-primary-foreground tracking-wider">
