...
const DynamicQuestionCard = dynamic(() => 
  import('@/components/game/QuestionCard').then(mod => mod.QuestionCard), 
  { ssr: false, loading: () => <div className="flex items-center justify-center"><LoadingSpinner /></div> }
);
